...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/haystack-ai-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/haystack-ai-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add haystack-ai
# for installing globally
pixi global install haystack-ai
```
...
It is possible to list all of the versions of `haystack-ai` available on your platform:
...
```
pixi search haystack-ai --channel conda-forge
```
